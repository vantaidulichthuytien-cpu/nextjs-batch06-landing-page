...
const badges = [
  {
    ...
    desc: "Giá chốt trước, ghi vào hợp đồng",
  },
  {
    icon: ShieldCheck,
  ...
  },
  {
    icon: Clock,
    title: "Hỗ trợ 24/7",
    desc: "Nhận cả chuyến gấp trong ngày",
  },
];
      ...
      <div className="relative mx-auto max-w-7xl px-6 pb-28 pt-16 sm:pt-20 lg:px-8">
        <div className="max-w-xl">
          ...
          <p className="mt-5 text-lg text-slate-600">
            Cho thuê xe du lịch từ 4 đến 47 chỗ kèm tài xế. Gửi lộ trình, nhận
            báo giá trọn gói trong 5 phút — và giá đó không đổi tới cuối chuyến.
          </p>
